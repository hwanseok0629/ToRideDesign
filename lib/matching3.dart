...
class Matching3 extends StatelessWidget {
  Matching3({
    Key ? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 51.0, middle: 0.7645),
            Pin(size: 51.0, middle: 0.395),
            child:
                // Adobe XD layer: 'Cir' (shape)
                Container(
              decoration: BoxDecoration(
          ...
          Pinned.fromPins(
            Pin(size: 6.0, middle: 0.734),
            Pin(size: 6.0, middle: 0.4036),
            child: Container(
              decoration: BoxDecoration(
                borderRadius:
                    BorderRadius.all(Radius.elliptical(9999.0, 9999.0)),
