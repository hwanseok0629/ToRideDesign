    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 53.0, middle: 0.7613),
            Pin(size: 95.9, middle: 0.3555),
            child:
                // Adobe XD layer: 'Place_Icon' (group)
                Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(size: 28.0, middle: 0.538),
