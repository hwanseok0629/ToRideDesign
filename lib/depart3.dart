...
class Depart3 extends StatelessWidget {
  Depart3({
    Key ? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(start: 20.5, end: 50.5),
            Pin(size: 176.0, middle: 0.6129),
            child:
                // Adobe XD layer: 'Arrive' (group)
                PageLink(
              links: [
                PageLinkInfo(
                  transition: LinkTransition.Fade,
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromPins(
                    Pin(size: 8.0, start: 23.5),
                    Pin(start: 20.0, end: 20.0),
                    child:
                        // Adobe XD layer: 'Ari_Cir' (group)
                        Stack(
                      children: <Widget>[
                        Pinned.fromPins(
                          Pin(start: 0.0, end: 0.0),
                  ...
                  Pinned.fromPins(
                    Pin(size: 217.4, start: 46.5),
                    Pin(start: 0.0, end: 0.0),
                    child:
                        // Adobe XD layer: 'Ari_Name' (group)
                        Stack(
                      children: <Widget>[
                        Pinned.fromPins(
                          Pin(start: 0.0, end: 0.0),
                  ...
                  Pinned.fromPins(
                    Pin(start: 0.0, end: 0.0),
                    Pin(size: 1.0, middle: 0.6783),
                    child:
                        // Adobe XD layer: 'Ari2_Line' (shape)
                        SvgPicture.string(
                      _svg_wwvsk,
                      allowDrawingOutsideViewBox: true,
                      fit: BoxFit.fill,
                  ...
                  Pinned.fromPins(
                    Pin(start: 0.0, end: 0.0),
                    Pin(size: 1.0, middle: 0.3126),
                    child:
                        // Adobe XD layer: 'Ari1_Line' (shape)
                        SvgPicture.string(
                      _svg_ygjw,
                      allowDrawingOutsideViewBox: true,
                      fit: BoxFit.fill,
          ...
          Pinned.fromPins(
            Pin(size: 51.0, end: 56.0),
            Pin(size: 164.0, middle: 0.6109),
            child:
                // Adobe XD layer: 'Ari_Btn' (group)
                Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
                ...
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
                  Pin(size: 26.0, middle: 0.5072),
                  child:
                      // Adobe XD layer: 'Ari_Btn2' (group)
                      Stack(
                    children: <Widget>[
                      Pinned.fromPins(
                        Pin(start: 0.0, end: 0.0),
...
const String _svg_ux3f5 =
    '<svg viewBox="0.0 -22.0 412.0 622.0" ><path transform="translate(0.0, -22.0)" d="M 25.35384750366211 0 L 386.6461791992188 0 C 400.6487121582031 0 412.0000305175781 10.74516487121582 412.0000305175781 24 L 412.0000305175781 598 C 412.0000305175781 611.2548217773438 400.6487121582031 622 386.6461791992188 622 L 324.4794921875 622 L 257.9984741210938 622 L 25.35384750366211 622 C 11.35130310058594 622 0 611.2548217773438 0 598 L 0 24 C 0 10.74516487121582 11.35130310058594 0 25.35384750366211 0 Z" fill="#ffffff" stroke="#cacaca" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_wwvsk =
    '<svg viewBox="25.5 425.7 341.0 1.0" ><path transform="translate(25.5, 425.7)" d="M 341 0 L 0 0" fill="none" stroke="#cacaca" stroke-width="1" stroke-dasharray="1 1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_ygjw =
    '<svg viewBox="25.5 361.7 341.0 1.0" ><path transform="translate(25.5, 361.7)" d="M 341 0 L 0 0" fill="none" stroke="#cacaca" stroke-width="1" stroke-dasharray="1 1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
